...
(function (global) {
  ...
  let features = {
    localNotifications: new Feature({
      ...
      description: `Local notifications, available through <b>Notifications API</b>, allow the authorized web applications to draw users attention
    ...
    pushNotifications: new Feature({
      ...
      description: [`Remote Push Notifications allow web applications to subscribe the user to the re-engagement mechanism
       ...
       of <b>Service Workers</b>, code units installable by the web app that execute separately in the background.`,
