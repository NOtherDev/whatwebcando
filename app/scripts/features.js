...
(function (global) {
  ...
  let features = {
    localNotifications: new Feature({
      ...
      description: [`Notifications, available through the <b>Notifications API</b>, allow authorized web applications to draw users attention
  ...
  "display": "standalone"
    ...
    bluetooth: new Feature({
      ...
      name: 'Bluetooth',
      description: [`The <b>Web Bluetooth API</b> is a low-level API allowing web applications to access the services exposed by nearby Bluetooth-enabled devices.`,
    ...
    nfc: new Feature({
      ...
      icon: 'mdi-device-nfc',
      name: 'NFC',
      description: [`The <b>Web NFC API</b> is a low-level API allowing web applications to access the data accessible on the Near-Field Communication devices nearby.`,
