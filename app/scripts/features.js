...
function log(info) {
  ...
  margin-right: 1em;
    ...
    memory: new Feature({
      ...
      `The API consists of two parts. The first is the memory size exposed via the JavaScript property. The second is the <a href="http://httpwg.org/http-extensions/client-hints.html">Client Hint</a> mechanism of the browser
